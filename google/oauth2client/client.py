...
import httplib2
from google.oauth2client import clientsecrets
from google.oauth2client import GOOGLE_AUTH_URI
from google.oauth2client import GOOGLE_DEVICE_URI
from google.oauth2client import GOOGLE_REVOKE_URI
from google.oauth2client import GOOGLE_TOKEN_URI
from google.oauth2client import util

HAS_OPENSSL = False
HAS_CRYPTO = False
try:
  from google.oauth2client import crypt
  HAS_CRYPTO = True
...
def _get_application_default_credential_GAE():
  from google.oauth2client.appengine import AppAssertionCredentials

  return AppAssertionCredentials([])


def _get_application_default_credential_GCE():
  from google.oauth2client.gce import AppAssertionCredentials
