...
from google.apiclient.errors import BatchError
from google.apiclient.errors import HttpError
from google.apiclient.errors import InvalidChunkSizeError
from google.apiclient.errors import ResumableUploadError
from google.apiclient.errors import UnexpectedBodyError
from google.apiclient.errors import UnexpectedMethodError
from google.apiclient.model import JsonModel
from google.oauth2client import util
...
class MediaIoBaseDownload(object):
  ...
  def __init__(self, fd, request, chunksize=DEFAULT_CHUNK_SIZE):
    ...
    Args:
      fd: io.Base or file object, The stream in which to write the downloaded
        bytes.
      request: google.apiclient.http.HttpRequest, the media request to perform in
        chunks.
  ...
  def next_chunk(self, num_retries=0):
    ...
    Raises:
      google.apiclient.errors.HttpError if the response was not a 2xx.
...
class HttpRequest(object):
  ...
  def _process_response(self, resp, content):
    ...
    Raises:
      google.apiclient.errors.HttpError if the response was not a 2xx or a 308.
    """
...
class BatchHttpRequest(object):
  ...
  Example:
    from google.apiclient.http import BatchHttpRequest
  ...
  def __init__(self, callback=None, batch_uri=None):
    ...
    Args:
      callback: callable, A callback to be called for each response, of the
        ...
        third is an google.apiclient.errors.HttpError exception object if an HTTP error
  ...
  def _execute(self, http, order, requests):
    ...
    Raises:
      httplib2.HttpLib2Error if a transport error has occured.
      google.apiclient.errors.BatchError if the response is the wrong format.
    """
...
class RequestMockBuilder(object):
  """A simple mock of HttpRequest
    ...
    Example:
      ...
      google.apiclient.discovery.build("plus", "v1", requestBuilder=requestBuilder)
