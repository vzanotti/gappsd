...
# Local imports
from google.apiclient import mimeparse
from google.apiclient.errors import HttpError
from google.apiclient.errors import InvalidJsonError
from google.apiclient.errors import MediaUploadSizeError
from google.apiclient.errors import UnacceptableMimeTypeError
from google.apiclient.errors import UnknownApiNameOrVersion
from google.apiclient.errors import UnknownFileType
from google.apiclient.http import HttpRequest
from google.apiclient.http import MediaFileUpload
from google.apiclient.http import MediaUpload
from google.apiclient.model import JsonModel
from google.apiclient.model import MediaModel
from google.apiclient.model import RawModel
from google.apiclient.schema import Schemas
from google.oauth2client.client import GoogleCredentials
from google.oauth2client.util import _add_query_parameter
from google.oauth2client.util import positional
...
def build(serviceName,
  ...
  Args:
    ...
    model: google.apiclient.Model, converts to and from the wire format.
    requestBuilder: google.apiclient.http.HttpRequest, encapsulator for an HTTP
      request.
  ...
  def __init__(self, http, baseUrl, model, requestBuilder, developerKey,
    ...
    Args:
      ...
      requestBuilder: class or callable that instantiates an
          google.apiclient.HttpRequest object.
      developerKey: string, key obtained from
          https://code.google.com/apis/console
